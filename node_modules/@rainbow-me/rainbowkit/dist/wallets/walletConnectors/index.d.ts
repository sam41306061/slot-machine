export declare const wallet: {
    ...
    omni: ({ chains }: import("./omni/omni").OmniOptions) => import("../Wallet").Wallet<import("wagmi").Connector<any, any>>;
    rainbow: ({ chains }: import("./rainbow/rainbow").RainbowOptions) => import("../Wallet").Wallet<import("wagmi").Connector<any, any>>;
    /** @deprecated */
    steak: ({ chains }: import("./omni/omni").OmniOptions) => import("../Wallet").Wallet<import("wagmi").Connector<any, any>>;
